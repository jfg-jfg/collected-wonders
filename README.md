...
| 2 | [回声 · ECHO](echo/index.html) | 游戏 / 解谜 | 无光迷宫中，以回声照亮前路 | **主线十二层**（六种结构风格：柱阵/梳齿/蜂巢/迷津/螺旋/沉街，全部经 BFS 结构验证；九层沉城 + 三层登塔终章「灯室/油路/天光」——与纸间《守灯人》同一座灯塔）· **钥匙与天光之门**（塔层及无尽每五层出口上锁——日记写过「钥匙挂在门后第三颗钉子上」；先寻钥匙再出门，锁孔/钥匙/拾取音全链路）· **蓄力声呐**（长按蓄力照得更远，但游魂闻声疾行数秒——风险回报）· **守灯人日记叙事**（碎片台词随层递进，末页署名周远）· **游魂 AI v3 + 三型分魂**（趋声魂循声追击 / 游荡魂充耳不闻 / 守灯魂巡守碎片与出口——各型配色、音高、步频各异，首遇自动介绍；BFS 最短路集合 + 评分走位：永不堵死必经之路、可声东击西）· 壁龛躲避 · 余像/尾迹 · 12 成就墙 · 每日深潜 · 无尽下潜（越深魂越多、步频越快、回光熄得越快）· **造井编辑器**（自定义尺寸+碎片台词+JSON 关卡码）· 小地图 · 近距分型低鸣 |
