...
| 2 | [回声 · ECHO](echo/index.html) | 游戏 / 解谜 | 无光迷宫中，以回声照亮前路 | **主线九层**（六种结构风格：柱阵/梳齿/蜂巢/迷津/螺旋/沉街，全部经 BFS 结构验证）· **守灯人日记叙事**（碎片台词随层递进）· **游魂 AI v3**（BFS 最短路集合 + 评分走位：永不堵死必经之路、趋声而行、可声东击西）· 壁龛躲避 · 余像/尾迹 · 11 成就墙 · 每日深潜 · 无尽下潜 · **造井编辑器**（自定义尺寸+碎片台词+JSON 关卡码）· 小地图 · 近距低鸣 |
...
- **回声**：方向键/WASD 移动 · 空格/点击发声呐 · `#lv0`~`#lv8` 直达关卡
